...
class UserController extends Controller
{
    ...
    public function user_store(Request $request)
    {
        try {
            ...
            $object->save();
            $this->logUserActivity('User', 'Created a new user: ' . $request->email);
    ...
    public function user_update(Request $request)
    {
        try {
            ...
            $object->status = $request->status;
            $object->save();
            $this->logUserActivity('User', 'Updated user for: ' . $request->email);
    ...
    public function user_delete($user_id)
    {
        try {
            ...
            $object->delete();
            $this->logUserActivity('User', 'Removed user: ' . $object->email);
