                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-item wow fadeInUp delay-0-2s">
                            ...
                            <p>Dorbesh gives you the blocks & kits you need to create a true website within minutes.</p>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="skill-item wow fadeInUp delay-0-2s">
                                    <img src="{{ asset('visitor/dorbesh/images/skills/skill1.png') }}" alt="Skill" />
                                    <h5>Figma</h5>
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="skill-item wow fadeInUp delay-0-3s">
                                    <img src="{{ asset('visitor/dorbesh/images/skills/skill2.png') }}" alt="Skill" />
                                    <h5>Tailwand</h5>
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="skill-item wow fadeInUp delay-0-4s">
                                    <img src="{{ asset('visitor/dorbesh/images/skills/skill3.png') }}" alt="Skill" />
                                    <h5>Photoshop</h5>
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="skill-item wow fadeInUp delay-0-5s">
                                    <img src="{{ asset('visitor/dorbesh/images/skills/skill4.png') }}" alt="Skill" />
                                    <h5>WordPress</h5>
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="skill-item wow fadeInUp delay-0-2s">
                                    <img src="{{ asset('visitor/dorbesh/images/skills/skill5.png') }}" alt="Skill" />
                                    <h5>Angular</h5>
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="skill-item wow fadeInUp delay-0-3s">
                                    <img src="{{ asset('visitor/dorbesh/images/skills/skill6.png') }}" alt="Skill" />
                                    <h5>Webflow</h5>
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="skill-item wow fadeInUp delay-0-4s">
                                    <img src="{{ asset('visitor/dorbesh/images/skills/skill7.png') }}" alt="Skill" />
                                    <h5>Python</h5>
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="skill-item wow fadeInUp delay-0-5s">
                                    <img src="{{ asset('visitor/dorbesh/images/skills/skill8.png') }}" alt="Skill" />
                                    <h5>Sketch</h5>
                ...
                <div class="row project-masonry-active">
                    ...
                    <div class="col-lg-4 col-md-6 item design marketing graphics">
                        <div class="project-item style-two wow fadeInUp delay-0-4s">
                            <div class="project-image">
                                <img src="{{ asset('visitor/dorbesh/images/projects/work2.jpg') }}" alt="Project">
                    ...
                    <div class="col-lg-4 col-md-6 item design marketing graphics">
                        <div class="project-item style-two wow fadeInUp delay-0-8s">
                            <div class="project-image">
                                <img src="{{ asset('visitor/dorbesh/images/projects/work6.jpg') }}" alt="Project">
                                <a href="https://www.youtube.com/watch?v=qZEPs3vmYB4" class="details-btn popup-youtube"><i
                                        class="ri-arrow-right-up-line"></i></a>
                            </div>
                            <div class="project-content">
        ...
        <div class="container">
            ...
            <div class="client-logo-wrap">
                <a class="client-logo-item wow fadeInUp delay-0-2s">
                    <img src="{{ asset('visitor/dorbesh/images/client-logos/partner1.png') }}" alt="brand Logo" />
                </a>
                <a class="client-logo-item wow fadeInUp delay-0-3s">
                    <img src="{{ asset('visitor/dorbesh/images/client-logos/partner2.png') }}" alt="brand Logo" />
                </a>
                <a class="client-logo-item wow fadeInUp delay-0-4s">
                    <img src="{{ asset('visitor/dorbesh/images/client-logos/partner3.png') }}" alt="brand Logo" />
                </a>
                <a class="client-logo-item wow fadeInUp delay-0-5s">
                    <img src="{{ asset('visitor/dorbesh/images/client-logos/partner4.png') }}" alt="brand Logo" />
                </a>
        ...
        <div class="container">
            ...
            <div class="row blog-post-box align-items-center">
                <div class="col-lg-6">
                    <div class="blog-post-img">
                        <a href="#">
                            <img src="{{ asset('visitor/dorbesh/images/blog/blog1.jpg') }}" alt="">
                        </a>
                ...
                <div class="col-lg-6">
                    <div class="blog-post-caption">
                        ...
                        <h2><a class="link-decoration" href="single-project.html">Create a Landing Page That Performs
                                Great</a></h2>
                        <a class="theme-btn theme-btn-two" href="single-project.html">Read more <i
            ...
            <div class="row blog-post-box align-items-center">
                <div class="col-lg-6">
                    <div class="blog-post-img">
                        <a href="#">
                            <img src="{{ asset('visitor/dorbesh/images/blog/blog2.jpg') }}" alt="">
                        </a>
                        <div class="blog-post-category">
                            <a href="#">Branding</a>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="blog-post-caption">
                        <h3>Posted on november 28</h3>
                        <h2><a class="link-decoration" href="single-project.html">Starting and Growing a Career in Web
                                Design</a></h2>
                        <a class="theme-btn theme-btn-two" href="single-project.html">Read more <i
                                class="ri-arrow-right-line"></i></a>
                    </div>
            ...
            <div class="row blog-post-box align-items-center">
                <div class="col-lg-6">
                    <div class="blog-post-img">
                        <a href="#">
                            <img src="{{ asset('visitor/dorbesh/images/blog/blog3.jpg') }}" alt="">
                        </a>
                        <div class="blog-post-category">
                            <a href="#">Design</a>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="blog-post-caption">
                        <h3>Posted on november 28</h3>
                        <h2><a class="link-decoration" href="single-project.html">How Can Designers Prepare for the
                                Future?</a></h2>
                        <a class="theme-btn theme-btn-two" href="single-project.html">Read more <i
                                class="ri-arrow-right-line"></i></a>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <label for="email" class="for-icon"><i
