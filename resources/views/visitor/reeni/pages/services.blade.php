        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-6">
                    <a href="{{ route('visitor.service.details', ['service' => 'business-consulting']) }}"
                    ...
                    <a href="{{ route('visitor.service.details', ['service' => 'app-consulting']) }}"
                ...
                <div class="col-lg-6 col-sm-6">
                    <a href="{{ route('visitor.service.details', ['service' => 'ui-visual-design']) }}"
                    ...
                    <a href="{{ route('visitor.service.details', ['service' => 'motion-design']) }}"
