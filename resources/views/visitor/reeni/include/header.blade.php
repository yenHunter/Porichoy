        ...
        <div class="inner">
            <div class="top-area">
                <a href="index.html" class="logo">
                    <img class="logo-dark" src="{{ asset('visitor/reeni/images/logo/white-logo-reeni.png') }}"
                        alt="Reeni - Personal Portfolio HTML Template for developers and freelancers">
                    <img class="logo-white" src="{{ asset('visitor/reeni/images/logo/logo-white.png') }}"
                        alt="Reeni - Personal Portfolio HTML Template for developers and freelancers">
                </a>
            ...
            <div class="content-wrapper">
                <div class="image-area-feature">
                    <a href="index.html">
                        <img src="{{ asset('visitor/reeni/images/logo/man.png') }}" alt="personal-logo">
                    </a>
                </div>
