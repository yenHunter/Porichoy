                ...
                <div class="col-xxl-4 col-md-6 col-sm-8">
                    <div class="card p-4">
                        ...
                        <div class="auth-brand text-center mb-4">
                            ...
                            <p class="text-muted w-lg-75 mt-3 mx-auto">We've emailed you a 6-digit verification code. Please
                        ...
                        <form>
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input class="form-control" disabled="" id="userEmail" placeholder="you@example.com"
                                        type="email" />
                                </div>
                            </div>
                            <div class="mb-3">
