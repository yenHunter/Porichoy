@extends('layouts.base', ['title' => 'Delete Account'])
                                ...
                                <div class="mb-4">
                                    <div class="avatar-xxl mx-auto mt-2">
                                        <div
                                            ...
                                            <img alt="dark logo" height="64" src="/images/user-shield.png" />
                                        </div>
                                    </div>
                                </div>
                                <h4 class="fw-bold text-center mb-3">Account Deactivated</h4>
                                <p class="text-muted text-center mb-4">Your account is currently inactive. Reactivate now to
                                    regain access to all features and opportunities.</p>
                                <div class="d-grid">
