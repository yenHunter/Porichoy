            ...
            <div class="row justify-content-center">
                <div class="col-xxl-4 col-md-6 col-sm-8">
                    <div class="card p-4">
                        ...
                        <form action="{{ route('second', ['dashboard', 'index']) }}">
                            <div class="mb-3">
                                <label class="form-label" for="userEmail">Email address <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input class="form-control" id="userEmail" placeholder="you@example.com" required=""
                                        type="email" />
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a class="text-decoration-underline link-offset-3 text-muted"
                                    href="{{ route('second', ['auth', 'reset-pass']) }}">Forgot Password?</a>
                            </div>
                            <div class="d-grid">
                        ...
                        <p class="text-muted text-center mt-4 mb-0">
                            New here? <a class="text-decoration-underline link-offset-3 fw-semibold"
                                href="{{ route('second', ['auth', 'sign-up']) }}">Create an account</a>
                        </p>
                    </div>
