            ...
            <div class="row justify-content-center">
                <div class="col-xxl-4 col-md-6 col-sm-8">
                    <div class="card p-4">
                        ...
                        @endif
                        <form action="{{ route('login.attempt') }}" method="POST" id="login_form">
                            @csrf
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input class="form-control" name="email" placeholder="you@example.com" required
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input class="form-control" name="password" placeholder="••••••••" required
                                        type="password" />
                                </div>
                            </div>
                            ...
                            <div class="d-grid">
                                <button class="btn btn-primary fw-semibold py-2 g-recaptcha"
