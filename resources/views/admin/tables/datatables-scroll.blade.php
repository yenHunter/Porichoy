...
@section('content')
    @include('layouts.partials/page-title', ['subtitle' => 'Datatables', 'title' => 'Scroll'])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header justify-content-between">
                    ...
                    <a class="icon-link icon-link-hover link-primary fw-semibold"
                        href="https://datatables.net/examples/basic_init/scroll_y.html" target="_blank">View Docs <i
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped nowrap align-middle mb-0" id="vertical-scroll">
            ...
            <div class="card">
                <div class="card-header justify-content-between">
                    ...
                    <a class="icon-link icon-link-hover link-primary fw-semibold"
                        href="https://datatables.net/examples/basic_init/scroll_x.html" target="_blank">View Docs <i
                            class="ti ti-arrow-right bi align-middle fs-lg"></i></a>
                </div>
                <div class="card-body">
                    <table class="table table-striped nowrap align-middle mb-0" id="horizontal-scroll">
                        <thead class="thead-sm text-uppercase fs-xxs">
                            <tr>
                                <th>Company</th>
                                <th>Symbol</th>
