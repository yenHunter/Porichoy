@extends('layouts.vertical', ['title' => 'Show & Hide Columns Datatables'])
...
@section('content')
    @include('layouts.partials/page-title', ['subtitle' => 'Datatables', 'title' => 'Show & Hide Columns'])
            ...
            <div class="card">
                <div class="card-header justify-content-between">
                    ...
                    <a class="icon-link icon-link-hover link-primary fw-semibold"
                        href="https://datatables.net/examples/api/show_hide.html" target="_blank">View Docs <i
