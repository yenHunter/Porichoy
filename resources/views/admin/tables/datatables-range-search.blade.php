@extends('layouts.vertical', ['title' => 'Range Search'])
...
@section('content')
    @include('layouts.partials/page-title', ['subtitle' => 'DataTables', 'title' => 'Range Search'])
            ...
            <div class="card">
                <div class="card-header justify-content-between">
                    ...
                    <a class="icon-link icon-link-hover link-primary fw-semibold"
                        href="https://datatables.net/examples/plug-ins/range_filtering.html" target="_blank">View Docs <i
