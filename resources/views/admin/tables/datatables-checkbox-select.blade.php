...
@section('content')
    @include('layouts.partials/page-title', ['subtitle' => 'DataTables', 'title' => 'Checkbox Select'])
            ...
            <div class="card">
                <div class="card-header justify-content-between">
                    ...
                    <a class="icon-link icon-link-hover link-primary fw-semibold"
                        href="https://datatables.net/extensions/select/examples/checkbox/checkbox.html" target="_blank">View
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped dt-responsive checkbox-select-datatable align-middle mb-0"
                        id="checkbox-select-data">
