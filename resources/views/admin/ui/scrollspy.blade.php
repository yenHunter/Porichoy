...
@section('content')
    @include('layouts.partials/page-title', ['subtitle' => 'UI', 'title' => 'Scrollspy'])
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <div class="overflow-auto mt-2 position-relative" data-bs-offset="0" data-bs-spy="scroll"
                                data-bs-target="#navbar-example3" style="height: 300px;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <div class="overflow-auto mt-2 position-relative" data-bs-offset="0" data-bs-spy="scroll"
                                data-bs-target="#list-example" style="height: 200px;">
