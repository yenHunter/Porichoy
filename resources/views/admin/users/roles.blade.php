    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex align-items-sm-center flex-sm-row flex-column my-3">
                ...
                <div class="text-end">
                    <a class="btn btn-success" data-bs-target="#addRoleModal" data-bs-toggle="modal"
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a class="dropdown-item"
                                                    href="{{ route('second', ['users', 'role-details']) }}"><i
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a class="btn btn-sm btn-outline-primary rounded-pill"
                                    href="{{ route('second', ['users', 'role-details']) }}">Details</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <ul class="list-unstyled mb-3">
                                <li class="d-flex align-items-center mb-2"><span
                                        class="ti ti-check fs-lg text-success me-2"></span> Timeline Tracking
                                </li>
                                <li class="d-flex align-items-center mb-2"><span
                                        class="ti ti-check fs-lg text-success me-2"></span> Task Assignments
                                </li>
                                <li class="d-flex align-items-center mb-2"><span
                                        class="ti ti-check fs-lg text-success me-2"></span> Budget Control
                                </li>
                                <li class="d-flex align-items-center"><span
                                        class="ti ti-check fs-lg text-success me-2"></span> Stakeholder
                                    Reporting
                                </li>
                            </ul>
                            <p class="mb-2 text-muted">Total 5 users</p>
                            <div class="avatar-group avatar-group-sm mb-3">
                                <div class="avatar"><img alt="" class="rounded-circle avatar-sm"
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <ul class="list-unstyled mb-3">
                                <li class="d-flex align-items-center mb-2"><span
                                        class="ti ti-check fs-lg text-success me-2"></span> Codebase Maintenance
                                </li>
                                <li class="d-flex align-items-center mb-2"><span
                                        class="ti ti-check fs-lg text-success me-2"></span> API Integration
                                </li>
                                <li class="d-flex align-items-center mb-2"><span
                                        class="ti ti-check fs-lg text-success me-2"></span> Unit Testing
                                </li>
                                <li class="d-flex align-items-center"><span
                                        class="ti ti-check fs-lg text-success me-2"></span> Feature Deployment
                                </li>
                            </ul>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <ul class="list-unstyled mb-3">
                                <li class="d-flex align-items-center mb-2"><span
                                        class="ti ti-check fs-lg text-success me-2"></span> Respond to Tickets
                                </li>
                                <li class="d-flex align-items-center mb-2"><span
                                        class="ti ti-check fs-lg text-success me-2"></span> Live Chat
                                    Supervision
                                </li>
                                <li class="d-flex align-items-center mb-2"><span
                                        class="ti ti-check fs-lg text-success me-2"></span> FAQ Updates
                                </li>
                                <li class="d-flex align-items-center"><span
                                        class="ti ti-check fs-lg text-success me-2"></span> Support Metrics
                                    Review
                                </li>
                            </ul>
                            ...
                            <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                    ...
                                    <tr class="text-uppercase fs-xxs">
                                        <th class="ps-3" style="width: 1%;">
                                            <input class="form-check-input form-check-input-light fs-14 mt-0"
                                                data-table-select-all="" id="select-all-files" type="checkbox"
                                                value="option" />
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="m-0"><a class="link-reset" href="#">#USR00123</a>
                                            </h5>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    <h5 class="fs-base mb-0"><a class="link-reset" data-sort="user"
                                                            href="{{ route('second', ['users', 'profile']) }}">Nathan
                                                            Young</a></h5>
                                    ...
                                    <tr>
                                        <td class="ps-3"><input
                                                ...
                                                type="checkbox" /></td>
                                        <td>
                                            <h5 class="m-0"><a class="link-reset" href="#">#USR00145</a>
                                            </h5>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    <h5 class="fs-base mb-0"><a class="link-reset" data-sort="user"
                                                            href="{{ route('second', ['users', 'profile']) }}">Leah
                                                            Kim</a></h5>
                                    ...
                                    <tr>
                                        <td class="ps-3"><input
                                                ...
                                                type="checkbox" /></td>
                                        <td>
                                            <h5 class="m-0"><a class="link-reset" href="#">#USR00162</a>
                                            </h5>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    <h5 class="fs-base mb-0"><a class="link-reset" data-sort="user"
                                                            href="{{ route('second', ['users', 'profile']) }}">Sophie
                                                            Lee</a></h5>
                                    ...
                                    <tr>
                                        <td class="ps-3"><input
                                                ...
                                                type="checkbox" /></td>
                                        <td>
                                            <h5 class="m-0"><a class="link-reset" href="#">#USR00178</a>
                                            </h5>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    <h5 class="fs-base mb-0"><a class="link-reset" data-sort="user"
                                                            href="{{ route('second', ['users', 'profile']) }}">David
                                                            Tran</a></h5>
                                    ...
                                    <tr>
                                        <td class="ps-3"><input
                                                ...
                                                type="checkbox" /></td>
                                        <td>
                                            <h5 class="m-0"><a class="link-reset" href="#">#USR00189</a>
                                            </h5>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    <h5 class="fs-base mb-0"><a class="link-reset" data-sort="user"
                                                            href="{{ route('second', ['users', 'profile']) }}">Isabella
                                                            Moore</a></h5>
                                    ...
                                    <tr>
                                        <td class="ps-3"><input
                                                ...
                                                type="checkbox" /></td>
                                        <td>
                                            <h5 class="m-0"><a class="link-reset" href="#">#USR00203</a>
                                            </h5>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    <h5 class="fs-base mb-0"><a class="link-reset" data-sort="user"
                                                            href="{{ route('second', ['users', 'profile']) }}">Daniel
                                                            Cooper</a></h5>
                                    ...
                                    <tr>
                                        <td class="ps-3"><input
                                                ...
                                                type="checkbox" /></td>
                                        <td>
                                            <h5 class="m-0"><a class="link-reset" href="#">#USR00215</a>
                                            </h5>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                    ...
                                    <tr>
                                        <td class="ps-3"><input
                                                ...
                                                type="checkbox" /></td>
                                        <td>
                                            <h5 class="m-0"><a class="link-reset" href="#">#USR00228</a>
                                            </h5>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                    ...
                                    <tr>
                                        <td class="ps-3"><input
                                                ...
                                                type="checkbox" /></td>
                                        <td>
                                            <h5 class="m-0"><a class="link-reset" href="#">#USR00239</a>
                                            </h5>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="roleName" placeholder="e.g. Developer, Project Manager"
                                    required="" type="text" />
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" for="roleDescription">Description</label>
                                <input class="form-control" id="roleDescription" placeholder="Brief description"
                                    required="" type="text" />
                            </div>
                            <div class="col-12">
                                <label class="form-label" for="roleResponsibilities">Key Responsibilities</label>
                                <textarea class="form-control" id="roleResponsibilities"
                                    placeholder="Enter responsibilities separated by commas or lines" required="" rows="4"></textarea>
                                <small class="text-muted">Example: Codebase Maintenance, API Integration, Unit
                                    Testing</small>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="roleIcon"
                                    placeholder="e.g. ti ti-shield, ti ti-briefcase" type="text" />
