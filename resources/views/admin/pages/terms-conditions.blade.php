        ...
        <div class="col-12">
            <div class="card position-relative">
                <div class="position-absolute top-0 end-0">
                    <svg fill="none" height="560" style="opacity: 0.05; width: 100%; height: auto;" viewbox="0 0 600 560"
                        width="600" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_948_1464)">
                            <mask height="1200" id="mask0_948_1464" maskunits="userSpaceOnUse" style="mask-type:luminance"
                                width="600" x="0" y="0">
                            ...
                            <mask height="1200" id="mask1_948_1464" maskunits="userSpaceOnUse" style="mask-type:luminance"
                                width="600" x="0" y="0">
                                <path d="M0 0L0 1200H600L600 0H0Z" fill="white"></path>
                            </mask>
                        ...
                        <defs>
                            <clippath id="clip0_948_1464">
                                <rect fill="white" height="600" transform="matrix(0 -1 1 0 0 560)" width="560">
                                </rect>
                            </clippath>
                        </defs>
                    </svg>
                ...
                <div class="card-body position-relative">
                    ...
                    <p class="mt-4">For any questions regarding these Terms, please contact us at <a
