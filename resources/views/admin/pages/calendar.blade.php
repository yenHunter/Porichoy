...
@push('js')
	...
	<script src="/admin/assets/plugins/fullcalendar/core/index.global.min.js"></script>
	<script src="/admin/assets/plugins/fullcalendar/daygrid/index.global.min.js"></script>
	<script src="/admin/assets/plugins/fullcalendar/timegrid/index.global.min.js"></script>
	<script src="/admin/assets/plugins/fullcalendar/list/index.global.min.js"></script>
	<script src="/admin/assets/plugins/fullcalendar/bootstrap/index.global.min.js"></script>
	<script src="/admin/assets/plugins/fullcalendar/interaction/index.global.min.js"></script>
	<script src="/admin/assets/js/demo/calendar.demo.js"></script>
@endpush
