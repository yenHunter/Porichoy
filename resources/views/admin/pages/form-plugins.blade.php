...
@push('css')
	...
	<link href="/admin/assets/plugins/bootstrap-slider/dist/css/bootstrap-slider.min.css" rel="stylesheet">
	<link href="/admin/assets/plugins/blueimp-file-upload/css/jquery.fileupload.css" rel="stylesheet">
	<link href="/admin/assets/plugins/summernote/dist/summernote-lite.css" rel="stylesheet">
	<link href="/admin/assets/plugins/spectrum-colorpicker2/dist/spectrum.min.css" rel="stylesheet">
	<link href="/admin/assets/plugins/select-picker/dist/picker.min.css" rel="stylesheet">
	<link href="/admin/assets/plugins/jquery-typeahead/dist/jquery.typeahead.min.css" rel="stylesheet">
@endpush

@push('js')
	<script src="/admin/assets/plugins/jquery-migrate/dist/jquery-migrate.min.js"></script>
	...
	<script src="/admin/assets/plugins/bootstrap-slider/dist/bootstrap-slider.min.js"></script>
	<script src="/admin/assets/plugins/jquery-typeahead/dist/jquery.typeahead.min.js"></script>
	<script src="/admin/assets/plugins/jquery.maskedinput/src/jquery.maskedinput.js"></script>
	<script src="/admin/assets/plugins/tag-it/js/tag-it.min.js"></script>
	<script src="/admin/assets/plugins/blueimp-file-upload/js/vendor/jquery.ui.widget.js"></script>
	<script src="/admin/assets/plugins/blueimp-tmpl/js/tmpl.min.js"></script>
	<script src="/admin/assets/plugins/blueimp-load-image/js/load-image.all.min.js"></script>
	<script src="/admin/assets/plugins/blueimp-canvas-to-blob/js/canvas-to-blob.min.js"></script>
	<script src="/admin/assets/plugins/blueimp-gallery/js/jquery.blueimp-gallery.min.js"></script>
	<script src="/admin/assets/plugins/blueimp-file-upload/js/jquery.iframe-transport.js"></script>
	<script src="/admin/assets/plugins/blueimp-file-upload/js/jquery.fileupload.js"></script>
	<script src="/admin/assets/plugins/blueimp-file-upload/js/jquery.fileupload-process.js"></script>
	<script src="/admin/assets/plugins/blueimp-file-upload/js/jquery.fileupload-image.js"></script>
	<script src="/admin/assets/plugins/blueimp-file-upload/js/jquery.fileupload-audio.js"></script>
	<script src="/admin/assets/plugins/blueimp-file-upload/js/jquery.fileupload-video.js"></script>
	<script src="/admin/assets/plugins/blueimp-file-upload/js/jquery.fileupload-validate.js"></script>
	<script src="/admin/assets/plugins/blueimp-file-upload/js/jquery.fileupload-ui.js"></script>
	<script src="/admin/assets/plugins/summernote/dist/summernote-lite.min.js"></script>
	<script src="/admin/assets/plugins/spectrum-colorpicker2/dist/spectrum.min.js"></script>
	<script src="/admin/assets/plugins/select-picker/dist/picker.min.js"></script>
	<script src="/admin/assets/plugins/highlightjs/cdn-assets/highlight.min.js"></script>
	<script src="/admin/assets/js/demo/highlightjs.demo.js"></script>
	<script src="/admin/assets/js/demo/form-plugins.demo.js"></script>
	<script src="/admin/assets/js/demo/sidebar-scrollspy.demo.js"></script>
@endpush
...
<img src="/admin/assets/img/gallery/gallery-1.jpg" alt="" width="283" class="rounded float-start me-3 mb-3">
<div>
