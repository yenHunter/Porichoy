							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<a href="/page/product/details">Force Majeure White T Shirt</a>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<a href="/page/product/details">Eco-friendly fashion, organic cotton, slow fashion polo shirts</a>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<a href="/page/product/details">Nike Shoes (Red Color)</a>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<a href="/page/product/details">Nike Air Max (Blue Color)</a>
										</div>
									</div>
								</td>
								<td class="align-middle">19 in stock for 1 variants</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<a href="/page/product/details">Skate Sneaker (Orange Color)</a>
										</div>
									</div>
								</td>
								<td class="align-middle">19 in stock for 1 variants</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<a href="/page/product/details">Teen Fashion T-shirt (Black)</a>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<a href="/page/product/details">Levis Blue Jeans</a>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<a href="/page/product/details">Boots (White Color)</a>
										</div>
									</div>
								</td>
								<td class="align-middle">19 in stock for 1 variants</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<a href="/page/product/details">Hiking Boots</a>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<a href="/page/product/details">Dress (Pink)</a>
										</div>
									</div>
								</td>
