                ...
                <div class="col-xxl-4 col-md-6 col-sm-8">
                    <div class="card p-4">
                        ...
                        <div class="auth-brand text-center mb-3">
                            ...
                            <p class="text-muted w-lg-75 mt-3 mx-auto">We've emailed you a 6-digit verification code we sent
                                to</p>
                        </div>
                        ...
                        <p class="mt-4 text-muted text-center mb-4">Don’t have a code? <a
                            ...
                            <a class="text-decoration-underline link-offset-2 fw-semibold" href="#">Call Us</a></p>
