@extends('admin.layouts.vertical', ['title' => 'Blog Management'])
...
@section('content')
    @include('admin.layouts.partials.page-title', ['subtitle' => 'Module', 'title' => 'Blog'])
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header justify-content-between">
                    <div>
                        <h4 class="card-title mb-1">Blog Management</h4>
                        <p class="small mb-0 text-info">Manage all your blog posts here. Create new posts, edit existing ones, or remove outdated entries.</p>
                    </div>
