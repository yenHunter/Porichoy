	...
	<div class="row">
		...
		<div class="col-xl-6 mb-3">
			...
			<div class="card h-100 overflow-hidden">
				...
				<!-- BEGIN card-img-overlay -->
				<div class="card-img-overlay d-none d-md-block bg-blue rounded mb-n1 mx-n1" style="background-image: url(admin/assets/img/bg/wave-bg.png); background-position: right bottom; background-repeat: no-repeat; background-size: 100%;"></div>
				<!-- END card-img-overlay -->
			...
			<div class="card h-100">
				...
				<div class="card-body">
					...
					<div class="d-flex align-items-center mb-3">
						...
						<div class="flex-grow-1">
							<div>
								<div class="text-body fw-600">Macbook Pro 13 inch (2025)</div>
					...
					<div class="d-flex align-items-center mb-3">
						...
						<div class="flex-grow-1">
							<div>
								<div class="text-body fw-600">Apple Watch Series 4(2025)</div>
